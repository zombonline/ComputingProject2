...
import { getAllUniqueCommutes } from './utils/commute';
import {validateLocation, validateArrivalTime} from './utils/input_validation';
...
export default function CommuteTestScreen() {
  ...
  return (
    ...
    <Button title="View Possible Journeys" onPress={async ()=> {setJourneys(await getAllUniqueCommutes(origin, destination, arrivalTime, selectedDays))}} />
